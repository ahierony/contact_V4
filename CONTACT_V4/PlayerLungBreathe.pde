class PlayerLungBreathe {
  ...
  void setExhale() {
    ...
    aVelocity = 0.01; //0.002; //0.004; // borland project space fall 2025 v3; //0.005; // 0.003 this for lisbon show IHCI// to test with keyboard 0.003// best for contact v3: 0.005;
